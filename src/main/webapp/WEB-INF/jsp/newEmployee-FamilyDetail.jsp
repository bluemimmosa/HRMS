...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Synergy Automation And Instrumentation : New Employee - Family Detail</title>
                ...
                fields: {
                    fatherName: {
                        validators: {
                                ...
                                notEmpty: {
                                message: 'Please enter your Fathers Name'
                            }
                        }
                    },
                    motherName: {
                        validators: {
                                ...
                                notEmpty: {
                                message: 'Please enter your Mothers Name'
                            }
                        }
                    },
                    grandFathersName: {
                        validators: {
                            notEmpty: {
                                message: 'Please enter your GrandFathers Name'
                            }
                        }
                    },
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <form:form class="well form-horizontal" method="POST" modelAttribute="newFamilyDetail" action="newFamilyDetail"  id="contact_form">
                    <!-- Text input-->
                    ...
                    <div class="form-group">
                      ...
                      <input id="fathersName" name="fathersName" path="fathersName" placeholder="Father Name" class="form-control"  type="text"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                      <input id="mothersName" name="mothersName" path="mothersName" placeholder="Mother Name" class="form-control"  type="text"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                      <input id="grandFathersName" name="grandFathersName" path="grandFathersName" placeholder="GrandFathers Name" class="form-control"  type="text"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                      <input id="spouse" name="spouse" path="spouse" placeholder="Spouse Name" class="form-control"  type="text"/>
                        </div>
                      </div>
                    </div>
