...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Synergy Automation And Instrumentation : New Employee - Family Detail_Children</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <form:form class="well form-horizontal" method="POST" modelAttribute="newChildren" action="newChildren"  id="contact_form">
                    <!-- Text input-->
                    
                    <!-- Form Name -->
                    <Form:legend><center><h2><b>Employee - Family Details - Children Form</b></h2></center></Form:legend><br>
