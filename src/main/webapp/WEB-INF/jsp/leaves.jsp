...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Synergy Automation And Instrumentation : Leaves</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" style="height:670px; overflow:auto; padding:15px;" >
                        ...
                        <!--for calender-->
                        <div class="col-sm-12 col-md-4 well" id="content">
                             
                            <Form:legend><center><iframe src="https://www.hamropatro.com/widgets/calender-medium.php" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" style="border:none; overflow:hidden; width:295px; height:385px;" allowtransparency="true"></iframe></center></Form:legend>
                            

                        </div>
                        
                            <!--holidays-->
                            <div class="col-sm-12 col-md-8 well" id="content">
                            <div class="row">
                                <b>Holidays</b>
                            </div>
