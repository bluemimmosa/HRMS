...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Synergy Automation And Instrumentation : New Employee - Contact</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <form:form class="well form-horizontal" method="POST" modelAttribute="empcontact" action="empcontact"  id="contact_form">
                    <!-- Text input-->
                    ...
                    <div class="form-group">
                      ...
                      <input id="email" name="email" path="email" placeholder="Employee Email" class="form-control"  type="email"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input id="phone" name="phone" path="phone" placeholder="Phone Number" class="form-control"  type="text"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                      <input id="mobile" name="mobile" path="mobile" placeholder="Mobile Number" class="form-control"  type="text"/>
                        </div>
                      </div>
                    </div>
