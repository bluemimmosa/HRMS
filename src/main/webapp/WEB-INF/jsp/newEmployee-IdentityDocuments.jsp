...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Synergy Automation And Instrumentation : New Employee - Identity Documents</title>
                ...
                fields: {
                    ...
                    issueDate: {
                        validators: {
                                ...
                                notEmpty: {
                                message: 'Please enter your issued Date'
                            }
                        }
                    },
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <form:form class="well form-horizontal" method="POST" modelAttribute="newIdentityDocuments" action="newIdentityDocuments"  id="contact_form">
                    <!-- Text input-->
                    ...
                    <div class="form-group">
                      ...
                      <input id="number" name="number" path="number" placeholder="Identity Number" class="form-control"  type="text"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input id="identityFile" name="identityFile" path="identityFile" placeholder="Identity File" class="form-control" type="file"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group"> 
                      <label class="col-md-4 control-label">Identity Type</label>
                        ...
                        <select name="type" path="type" class="form-control selectpicker">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" id="issueDate" name="issueDate" path="issueDate" value="2018-07-22" min="1018-01-01" max="2021-6-1">
                      </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                      <input id="issuedBy" name="issuedBy" path="issuedBy" placeholder="Issued By" class="form-control"  type="text"/>
                        </div>
                      </div>
                    </div>
