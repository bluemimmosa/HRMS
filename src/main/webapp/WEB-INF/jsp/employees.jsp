...
<%@ page import="com.synergyani.hrms.entity.employee.Employee"%>
...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Synergy Automation And Instrumentation : Users</title>
                        ...
                        <div class="col-sm-12 col-md-12 well" id="content">
                            <div class="row">
                                ...
                                <div class="row-right-adduser">
                                    ...
                                    <a href="newEmployee-personalinfo" data-placement="bottom" data-toggle="tooltip" data-original-title="Add New Employee"><i class="fa fa-3x fas fa-user-plus"></i> </a>
                            ...
                            for(Employee e: empList){ %>
                                <tr>
                                    ...
                                    <td><%out.print(e.getDob());%></td>
                                    <td><%out.print(e.getGender());%></td>
                                    <td><%out.print(e.getMaritial());%></td>
                                    <td><%out.print(e.getPermaAddress().getMunicipality());%></td>
                                    <td><%out.print(e.getNationality());%></td>
                                    <td><%out.print(e.getPhotoFile());%></td>
                                    <td><a class="btn btn-info" href="userdetails"><span class="text">Details</span></a>
                                        <a class="btn btn-success" href="edituserdetails"><span class="text">Edit</span></a>
                                        <a class="btn btn-danger" href="deleteuser"><span class="text">Delete</span></a> 
                                    </td>
                                </tr>
                                <%
                            }
