...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Synergy Automation And Instrumentation : Job Information</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <form:form style="height:592px; overflow:auto; padding:15px;" class="well form-horizontal" method="POST" modelAttribute="newUser" action="newUser"  id="contact_form">
                    <!-- Text input-->
