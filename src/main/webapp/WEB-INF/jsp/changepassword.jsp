...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Synergy Automation And Instrumentation : Change Password</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4"><br>
                        ...
                        <button type="submit" class="btn btn-warning" >&nbsp&nbsp&nbsp&nbsp&nbsp  Change Password <span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button>
                      </div>
                    </div>
                    </form:form>
