...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Synergy Automation And Instrumentation : New Employee - Health</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <form:form class="well form-horizontal" method="POST" modelAttribute="newHealth" action="newHealth"  id="contact_form">
                    <!-- Text input-->
                    ...
                    <div class="form-group"> 
                      <label class="col-md-4 control-label">Blood Group Type</label>
                        ...
                        <select name="bloodGroup" path="bloodGroup" class="form-control selectpicker">
                    ...
                    <div class="form-group"> 
                      <label class="col-md-4 control-label">Diagnosis</label>
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                        <select name="diagnosis" path="diagnosis" class="form-control selectpicker">
                    ...
                    <div class="form-group">
                      ...
                      <input id="doctor" name="doctor" path="doctor" placeholder="Doctor Name" class="form-control"  type="text"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input id="emergencyContact" name="emergencyContact" path="emergencyContact" placeholder="Emergency Contact" class="form-control" type="text"/>
                        </div>
                      </div>
                    </div>
